...
urlpatterns = [
    ...
    path('placement/delete_offer_letter/<int:offer_id>/', views.delete_offer_letter, name='delete_offer_letter'),
...
path('update-higher-study/<int:higher_study_id>/', views.update_higher_study, name='update_higher_study'),
